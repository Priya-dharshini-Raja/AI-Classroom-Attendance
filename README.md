...
AI-Classroom-Attendance is an intelligent system that uses face recognition technology to automate student attendance in classrooms. It captures real-time images or video, detects faces, matches them with the student database, and records attendance automatically—reducing manual effort and errors.
